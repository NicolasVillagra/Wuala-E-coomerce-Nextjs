...
const ImageRestaurant = () => {
    const images = [
        'https://images.unsplash.com/photo-1508424757105-b6d5ad9329d0?q=80&w=1335&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Reemplaza con tus URLs de imágenes
